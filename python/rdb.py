...
def insert_tbl(cursor, conn, dict, tbl):
    fields = ''
    values = ''
    for k, v in dict.items():
        fields += k + ', '
    ...
    # Note take care of quote. Use JDBC instead
    cursor.execute("INSERT INTO {} ({})\
                    VALUES ('first_month_ma', 'APPL', '2018-01-01', 100, 1, 200);".format(tbl, fields, values))
    conn.commit()
    return 'Dict has been inserted to Table {}.'.format(tbl)
